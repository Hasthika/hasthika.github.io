...
## Publications 
* "Bootstrapping analogs of the One-Way MANOVA test," to appear, Communication in Statistics Theory and Methods, with David J Olive. 

* "A Relationship Between One-Way MANOVA Test Statistic and the Hotelling Lawley Trace Test Statistic," to appear: Vol. 7, No. 6, 2018, International Journal of Statistics and Probability.
...
* "Examining the $n \geq 30$ is Sufficiently Large Caveat for the Sampling Distribution of $\bar{X}$ to Follow a Normal Distribution",  submitted, with Alan Arnholt, William Bauldry and Lasanthi Watagoda.


* "A Machine Learning Approach to Automate an Inertial Sensor Based Sprint Assessment Method," submitted, with Reed D. Gurchiek, Lasanthi Watagoda, Ryan S. McGinnis, Alan Arnholt. 
