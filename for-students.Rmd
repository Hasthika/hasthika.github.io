...
```{r, echo = FALSE}
df <- data.frame(Time = c("08:00-09:15", "09:30-10:45", "11:00-12:00", "12:00-01:00","01:00-2:00","02:00-4:00"), Monday = c("Research", "Research", "Lunch", "Prep", "Prep", "Prep"), Tuesday = c("STT 2810","3850	101", "3850	102", "Lunch", "Grading", "Office"),  Wednesday =  c( "Grading", "3850	101", "3850	102", "Lunch", "Prep", "Prep"), Thurdsay =  c("STT 2810","3850	101", "3850	102", "Lunch", "Grading", "Office"))
