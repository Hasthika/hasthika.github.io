...
My office is in 324 Walker Hall (For the Fall of 2022, the office hours are online only check your course webpage for more info). Office hours for the Fall 2022 are listed below. Students may also click on [book now](https://hasthika.youcanbook.me/) to schedule an appointment during additional times listed.

```{r, echo = FALSE}

df <- data.frame(Time = c( "09:30-10:45", "11:15-12:15", "12:15-01:00","01:00-2:00","02:00-3:00"), Monday = c("Research", "Lunch", "Research", "Prep", "Prep"), Tuesday = c("STT 4830", "Online Office", "Lunch", "Research", "Office"),  Wednesday =  c("Research", "Research", "Lunch", "Office", "Office"), Thurdsay =  c("STT 4830", "Online Office", "Lunch", "Research", "Office"))
