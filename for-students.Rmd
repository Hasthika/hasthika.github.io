...
```{r, echo = FALSE}
df <- data.frame(Time = c("08:00-09:15", "09:30-10:45", "11:00-12:00", "12:00-01:00","01:00-2:00",""), Monday = c("Research", "Research", "Lunch", "Research", "Research", ""), Tuesday = c("3850	101", "3850	102", "Lunch", "Office", "Office", ""),  Wednesday =  c("3850	101", "3850	102", "Lunch", "Office", "Prep", ""), Thurdsay =  c("3850	101", "3850	102", "Lunch", "Office", "", ""))
