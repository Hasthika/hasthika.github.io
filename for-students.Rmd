...
```{r, echo = FALSE}
df <- data.frame(Time = c("08:00-09:15", "09:30-10:45", "11:00-12:15", "12:15-02:15"), Monday = c("Research", "Research", "Research", "Research"), Tuesday = c("STT 2810 - 102", "STT 3820 - 101", "STT 2810 - 104", "Research"), Wednesday = c(" ", "Office", "Office", "Office"), Thursday = c("STT 2810 - 102", "STT 3820 - 101", "STT 2810 - 104", "Research"), Friday = c("Research", "Research", "Research", "Research"))
